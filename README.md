...
当前非 Unity runtime 已具备：等距城市网格、住宅/商业/工业分区、道路铺设、道路升级、道路容量、清理工具、现金消耗、人口增长、道路覆盖、公共服务建筑、公园/医疗/教育覆盖、污染、拥堵、幸福度、城市评分、城市等级经验与解锁、地块检查、材料仓库、工厂生产队列、离线生产结算、城市订单交付、住宅材料升级、城市目标奖励、目标行动建议、微信本地存档和横屏 Canvas HUD。下面的大量系统来自历史 Unity 方案和产品规划，尚未全部迁移到当前微信 Canvas runtime。
- 网格地图、地形、水面和山地限制。
